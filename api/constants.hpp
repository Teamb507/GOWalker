...
#define VERT_SIZE 4*256 * 1024 * 1024            // 64M vertices in graph_buffer
#define EDGE_SIZE 4*1024* 1024 * 1024           // 256M edges in graph_buffer
#define FILE_SIZE 64 * 1024 * 1024 * 1024      // 64GB the maximum size of a file to store the data
